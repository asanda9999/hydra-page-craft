...
const Footer = () => {
  ...
  return (
    <footer className="bg-hydra-navy text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-hydra-teal" />
                <a href="mailto:hello@hydratechsolution.co.za" className="text-white/90 hover:text-hydra-teal transition-colors">
                  hello@hydratechsolution.co.za
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-hydra-teal" />
                <a href="tel:+27123456789" className="text-white/90 hover:text-hydra-teal transition-colors">
                  +27 (0) 123 456 789
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="w-5 h-5 text-hydra-teal" />
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <a 
                    href={link.href}
                    className="text-white/80 hover:text-hydra-teal transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <Button 
              variant="secondary" 
              className="bg-hydra-teal hover:bg-hydra-blue text-white border-none w-full"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-white/70 hover:text-hydra-teal transition-colors text-sm">
              Privacy Policy
            </a>
            <a href="#" className="text-white/70 hover:text-hydra-teal transition-colors text-sm">
              Terms of Service
