...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-hydra-light/20 to-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
            Get Your <span className="text-hydra-blue">Project Started</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <Card className="shadow-xl">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" variant="hydra" size="lg" className="w-full">
          ...
          <div className="space-y-8">
            <Card className="bg-gradient-to-br from-hydra-blue to-hydra-teal text-white shadow-xl">
              ...
              {contactInfo.map((info, index) => (
                <Card key={index} className="group hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-6 text-center">
                    <div className="mx-auto w-12 h-12 bg-gradient-to-br from-hydra-blue to-hydra-teal rounded-full flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform duration-300">
                      {info.icon}
                    </div>
                    ...
                    {info.link !== "#" ? (
                      <a 
                        href={info.link} 
                        className="text-hydra-blue hover:text-hydra-teal transition-colors"
                      >
                        {info.details}
                      </a>
                    ) : (
